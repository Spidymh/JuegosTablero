...
public class JugadorUI<S extends GameState<S,A>, A extends GameAction<S,A>> extends JFrame implements ColorChangeListener, BoardListener, GameObserver<S,A>{
	/**
	 * 
	 */
	...
	public void insertarElementosGUI(Container pane){
		...
		this.tablero = new TableroUI<S,A>(new TableroWas<S,A>(juego), juego, this.infoJugadores.getColor());
		repaint();
